...
const routes = [
  ...
  { path: '/edit-category', name: 'Update Category', element: UpdateCategory },
  { path: '/add-template', name: 'Add Template', element: addTemplate },
  { path: '/edit-template', name: 'Update Template', element: UpdateTemplate },
